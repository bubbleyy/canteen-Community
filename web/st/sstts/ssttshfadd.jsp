...
<div style="display: flex;align-items: center;margin-left: 30px;">
    <a href="${pageContext.request.contextPath}/SsttsServlet">
...
<div class="container" style="padding: 5px 30px;">
    <h3>食堂投诉回复</h3>
    <form id="AddInform" action="${pageContext.request.contextPath}/SsttshfAddServlet" method="post" >
        <input type="hidden" name="stts_id" value="${stts_id}">
