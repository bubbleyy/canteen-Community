        ...
        <table border="1" class="table table-bordered table-hover">
          ...
          <c:forEach items="${menupingluns}" var = "menupinglun" varStatus="s">
            <tr style="font-size: 14px">
              ...
              <td>
                <a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/AmenuplUpdateServlet?id=${menupinglun.id}">修改</a>&nbsp;
                <a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/AmenupldeleteServlet?id=${menupinglun.id}">删除</a>
              </td>
            </tr>
          </c:forEach>
        </table>
