...
@WebServlet("/AcommunityxxUpdateServlet")
public class AcommunityxxUpdateServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        community community = dao.findonlycommunity(id);
          ...
          List<String> communitypicture = JSONArray.fromObject(community.getPictures());
        request.setAttribute("community",community);
        request.setAttribute("communitypicture",communitypicture);
        request.getRequestDispatcher("admin/acommunity/asqxxupdate.jsp").forward(request,response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        community nowcommunity = new community();
        ...
        try {
            ...
            for (FileItem item : items){
                ...
                if (item.isFormField()) {
                    ...
                    if (name.equals("id")){
                        CommunityListDao dao = new CommunityListDaoimpI();
                        nowcommunity = dao.findonlycommunity(string);
                        community.setId(Integer.parseInt(string));
                    }
...
//                    String filename = URLEncoder.encode(item.getName(), "UTF-8");
            ...
            if (pictures.size() == 0 ){
                ...
                System.out.println(nowcommunity.getPictures());
                community.setPictures(nowcommunity.getPictures());
            }else {
            ...
            response.getWriter().print("修改社区信息成功");
