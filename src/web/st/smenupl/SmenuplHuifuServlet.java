...
@WebServlet("/SmenuplHuifuServlet")
public class SmenuplHuifuServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("菜品评论是"+menupinglun);
        ...
        request.getRequestDispatcher("st/smenupl/smenuplhuifudetail.jsp").forward(request,response);
