...
@WebServlet("/SstpinglunHuifuDetailServlet")
public class SstpinglunHuifuDetailServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("st/sstpl/sstplhfdetail.jsp").forward(request,response);
