    ...
    <table border="1" class="table table-bordered table-hover">
      ...
      <c:forEach items="${stpingluns}" var = "stpinglun" varStatus="s">
        <tr style="font-size: 14px">
          ...
          <td>
            <a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/SstpinglunHuifuDetailServlet?id=${stpinglun.id}">查看详情</a>&nbsp;
            <a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/SstplhfAddServlet?id=${stpinglun.id}">回复</a>
          </td>
        </tr>
      </c:forEach>
    </table>
