...
<div style="display: flex;align-items: center;margin-left: 30px;">
    <a href="${pageContext.request.contextPath}/SmenuplServlet">
...
<div class="container" style="padding: 5px 30px;">
    <h3>菜品评论回复</h3>
    <form id="AddInform" action="${pageContext.request.contextPath}/SmenuplhfAddServlet" method="post"  >
        <input type="hidden" name="menupl_id" value="${menupl_id}">
