...
<div style="display: flex;align-items: center;margin-left: 30px;">
    <a href="${pageContext.request.contextPath}/SMenuServlet">
...
<div class="container" style="padding: 5px 30px;">
    <h3>添加菜品页面</h3>
    <form id="AddInform" action="${pageContext.request.contextPath}/SMenuAddServlet" method="post" enctype="multipart/form-data" >
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="tw" name="tw" placeholder="如：五谷鱼粉">
        </div>

        <div class="form-group">
            <label for="money">价格：</label>
            <input type="text" class="form-control" id="money" name="money" placeholder="如：16/份">
        </div>

        <div class="form-group">
            <label for="type">类型：</label>
            <input type="text" class="form-control" id="type" name="type" placeholder="如：日常售价">
        </div>

        <div class="form-group">
            <label for="cuxiao">促销说明：</label>
            <input type="text" class="form-control" id="cuxiao" name="cuxiao" placeholder="有则填，无则填否">
        </div>
